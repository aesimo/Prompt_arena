  ...
  document.querySelectorAll('.bookmark-flat').forEach(btn => {
    btn.addEventListener('click', (e) => {
      ...
      if (btn.classList.contains('saved') && icon) {
        btn.querySelector('svg path').setAttribute('fill', 'var(--accent)');
        ...
        article.innerHTML = `
          ...
          <div class="card-body">
            ...
            <div class="card-footer">
              <span class="stat">
                <svg class="stat-heart" width="13" height="13" viewBox="0 0 24 24" fill="#e5e5e5" stroke="none"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>
                ${item.count}
              </span>
